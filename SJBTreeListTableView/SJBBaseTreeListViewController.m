...
- (void)viewDidLoad
{
    ...
    [cityDict1 setObject:@"北京" forKey:self.rowListName];
    ...
    [countryDict1 setObject:@"中国" forKey:self.sectionListName];
    
    ///另一个国家放令两个城市。
    NSMutableDictionary *cityDict21 = [NSMutableDictionary dictionary];
    [cityDict21 setObject:@"华盛顿" forKey:self.rowListName];
    NSMutableDictionary *cityDict22 = [NSMutableDictionary dictionary];
    [cityDict22 setObject:@"迈阿密" forKey:self.rowListName];
    NSMutableDictionary *cityDict23 = [NSMutableDictionary dictionary];
    [cityDict23 setObject:@"波士顿" forKey:self.rowListName];
    NSMutableDictionary *cityDict24 = [NSMutableDictionary dictionary];
    [cityDict24 setObject:@"费城" forKey:self.rowListName];
    ...
    [countryDict2 setObject:@"美国" forKey:self.sectionListName];
